...
class QuestionsController extends Controller
{
    ...
    {
        $subjects = Category::all()->where("school_id", school()->id);
    ...
    {
        $subject = Category::where("id", $id)->where("school_id", school()->id)->first();
    ...
    public function store(Request $request)
    {
        ...
        $groupid = '';
        $subject = Category::where("title", $request->subject)->where("school_id", school()->id)->first();
        if ($request->group_id == "") {
